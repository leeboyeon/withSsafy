...
data class User(
    ...
    constructor(userId: String, password: String, deviceToken: String) : this(id = 0, name = "", userId = userId, password = password, studentId = "", classRoomId = 0, state = 0, deviceToken = deviceToken)
